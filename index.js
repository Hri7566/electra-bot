...
/**
 * ---- ORIGINAL BOT (with comments for script.js and DOM stuff) ----
 */

// ==UserScript==
// @name      Electrashave's Bot MPPClone
// @namespace  http://www.multiplayerpiano.com/
// @notice   This was originally made by electrashave. And furthermore edited by LoganNZL ---- and hri
// @Version 3.1
// @description  Modded Script For Multiplayerpiano.com - edited by Hri7566
// @match http://www.multiplayerpiano.com/*
// @match https://mppclone.com/*
// @match http://www.multiplayerpiano.com/script.js
// @match https://mppclone.com/script.js
// @copyright  2013+
// ==/UserScript==
/* README
| toggles Echo
...
let channel_id = "✧𝓓𝓔𝓥 𝓡𝓸𝓸𝓶✧";
if (channel_id.substr(0, 1) == "/") channel_id = channel_id.substr(1);
// if (channel_id == "") channel_id = "lobby";

var gClient = new Client(`wss://mppclone.com:8443`, process.env.MPPCLONE_TOKEN);
...
gClient.on("a", function (msg) {
    ...
    if (message.substring(0, 4).toLowerCase() == "!bot") {
        ...
        if (message.substring(0, 1) == "!" && matched) {
            ...
            gClient.sendArray([{
                m: "a",
                message: "(NOT hosted with electra's permission) 2022 update: This bot is possibly the oldest MPP bot ever. It was made by electrashave in 2013. I, Hri7566, have brought it back to review the history of it. It originally ran in tampermonkey and is now hosted with NodeJS."
            }]);
            gClient.sendArray([{
                m: "a",
...
let botName = "electrabot (!help)";

gClient.on("hi", msg => {
    if (gClient.getOwnParticipant().name !== botName) {
        gClient.sendArray([{
            m: 'userset',
            set: {
                name: botName
